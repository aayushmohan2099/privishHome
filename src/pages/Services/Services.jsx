...
const SERVICES = [
  {
    ...
    icon: Monitor,
    idealFor: 'Local businesses, coaching centers, corporate firms, retail stores',
    summary: 'High-performance brand and marketing websites engineered for extreme responsiveness, fast initial loading times, and SEO ranking — built strictly to convert traffic into calls and leads.',
    features: [
  ...
  },
  {
    ...
    icon: Smartphone,
    idealFor: 'Multi-location operations, field surveyors, retail stores, consumer brands',
    summary: 'Custom Android and iOS mobile applications designed for smooth performance, offline capability, and frictionless deployment to app stores.',
    features: [
  ...
  },
  {
    ...
    icon: Database,
    idealFor: 'NGOs tracking community deliveries, local government-adjacent sectors, logistics',
    summary: 'Custom back-office management interfaces, administrative forms, and MIS portals that consolidate fragmented spreadsheets into clean visual feeds.',
    features: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    idealFor: 'Lucknow & Kanpur coaching hubs, vocational centers, corporate trainers',
    summary: 'Specialized admin portals designed for coaching institutes and training centers to manage enrollment, batch timings, trainer allocations, student progress, and attendance in a secure central dashboard.',
    features: [
  ...
  },
  {
    ...
    icon: ShoppingBag,
    idealFor: 'Medical stores, pharmaceutical distributors, local retailers, direct-to-consumer',
    summary: 'Affordable, customized digital storefronts integrated with Indian payment gateways (Razorpay, UPI QR) and real-time inventory control modules.',
    features: [
  ...
  },
  {
    ...
    icon: Server,
    idealFor: 'Long-term operational peace of mind, high-uptime web applications',
    summary: 'Ongoing server administration, secure automated backups, system security updates, and performance monitoring. We maintain a high-performance VPS setup with 10-20% AMC service level guarantees.',
    features: [
                    ...
                    <Card className="bg-cream/50">
                      ...
                      <ul className="space-y-3 font-['Plus_Jakarta_Sans']">
                        {service.features.map((feat, idx) => (
                          <li key={idx} className="flex items-start gap-2.5 text-xs text-body-text leading-relaxed">
      ...
      <section className="py-16 bg-cream border-t border-ink/5 text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <p className="text-sm text-body-text font-['Plus_Jakarta_Sans']">
            We scope custom integrations, multi-tenant databases, and custom automation workflows to fit your exact budget.
          </p>
