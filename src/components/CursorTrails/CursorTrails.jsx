// src\components\CursorTrails\CursorTrails.jsx
import React, { useEffect, useRef } from "react";

const DEFAULTS = {
  colors: ["#FD7B03", "#FD3502", "#6e3d15"], // Defaulted to Privish brand colors
  colorShift: 1,
  opacity: 50,
  thickness: 2,
  trails: 60,
...
export default function CursorTrails(props) {
  const {
  ...
  useEffect(() => {
    ...
    function onFirstMove(e) {
      ...
      moveTarget.addEventListener("touchmove", updatePosition, {
        passive: false,
      });
      updatePosition(e);
      buildLines();
